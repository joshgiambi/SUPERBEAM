        ...
        <div className="bg-white/10 backdrop-blur-md border border-white/40 rounded-xl px-2 py-2 shadow-2xl">
          <div className="flex space-x-2">
            ...
            <div className="relative">
              ...
              {showHistory && (
                <div className="absolute bottom-full right-0 mb-2 bg-black/95 border border-orange-400/50 rounded-lg shadow-2xl backdrop-blur-sm w-96 max-h-96 overflow-y-auto z-50">
